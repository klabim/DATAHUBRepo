...
describe('Service Tests', () => {
  describe('JobMySuffix Service', () => {
    ...
    beforeEach(() => {
      ...
      injector = getTestBed();
      service = injector.get(JobMySuffixService);
    ...
    describe('Service methods', () => {
      ...
      it('should create a JobMySuffix', () => {
        service.create(new JobMySuffix(null)).subscribe(received => {
      ...
      it('should update a JobMySuffix', () => {
        service.update(new JobMySuffix(123)).subscribe(received => {
      ...
      it('should return a JobMySuffix', () => {
