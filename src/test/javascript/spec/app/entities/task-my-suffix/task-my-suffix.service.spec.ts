...
describe('Service Tests', () => {
  describe('TaskMySuffix Service', () => {
    ...
    beforeEach(() => {
      ...
      injector = getTestBed();
      service = injector.get(TaskMySuffixService);
    ...
    describe('Service methods', () => {
      ...
      it('should create a TaskMySuffix', () => {
        service.create(new TaskMySuffix(null)).subscribe(received => {
      ...
      it('should update a TaskMySuffix', () => {
        service.update(new TaskMySuffix(123)).subscribe(received => {
      ...
      it('should return a TaskMySuffix', () => {
      ...
      it('should return a list of TaskMySuffix', () => {
        ...
        const req = httpMock.expectOne({ method: 'GET' });
        req.flush([new TaskMySuffix(123)]);
      });
