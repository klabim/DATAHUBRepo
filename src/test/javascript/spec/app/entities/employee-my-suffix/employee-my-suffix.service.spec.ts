  ...
  describe('EmployeeMySuffix Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a EmployeeMySuffix', () => {
        service.create(new EmployeeMySuffix(null)).subscribe(received => {
      ...
      it('should update a EmployeeMySuffix', () => {
        service.update(new EmployeeMySuffix(123)).subscribe(received => {
      ...
      it('should return a EmployeeMySuffix', () => {
      ...
      it('should return a list of EmployeeMySuffix', () => {
        ...
        const req = httpMock.expectOne({ method: 'GET' });
        req.flush([new EmployeeMySuffix(123)]);
      });
