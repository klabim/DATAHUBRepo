  ...
  describe('LocationMySuffix Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a LocationMySuffix', () => {
        service.create(new LocationMySuffix(null)).subscribe(received => {
      ...
      it('should update a LocationMySuffix', () => {
        service.update(new LocationMySuffix(123)).subscribe(received => {
      ...
      it('should return a LocationMySuffix', () => {
      ...
      it('should return a list of LocationMySuffix', () => {
        ...
        const req = httpMock.expectOne({ method: 'GET' });
        req.flush([new LocationMySuffix(123)]);
      });
