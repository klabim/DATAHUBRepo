...
describe('Service Tests', () => {
  describe('CountryMySuffix Service', () => {
    ...
    beforeEach(() => {
      ...
      injector = getTestBed();
      service = injector.get(CountryMySuffixService);
    ...
    describe('Service methods', () => {
      ...
      it('should create a CountryMySuffix', () => {
        service.create(new CountryMySuffix(null)).subscribe(received => {
      ...
      it('should update a CountryMySuffix', () => {
        service.update(new CountryMySuffix(123)).subscribe(received => {
      ...
      it('should return a CountryMySuffix', () => {
      ...
      it('should return a list of CountryMySuffix', () => {
        ...
        const req = httpMock.expectOne({ method: 'GET' });
        req.flush([new CountryMySuffix(123)]);
      });
