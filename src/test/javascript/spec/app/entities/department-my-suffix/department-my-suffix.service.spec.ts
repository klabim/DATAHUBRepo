  ...
  describe('DepartmentMySuffix Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a DepartmentMySuffix', () => {
        service.create(new DepartmentMySuffix(null)).subscribe(received => {
      ...
      it('should update a DepartmentMySuffix', () => {
        service.update(new DepartmentMySuffix(123)).subscribe(received => {
      ...
      it('should return a DepartmentMySuffix', () => {
      ...
      it('should return a list of DepartmentMySuffix', () => {
        ...
        const req = httpMock.expectOne({ method: 'GET' });
        req.flush([new DepartmentMySuffix(123)]);
      });
