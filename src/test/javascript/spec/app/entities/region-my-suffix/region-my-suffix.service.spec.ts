  ...
  describe('RegionMySuffix Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a RegionMySuffix', () => {
        service.create(new RegionMySuffix(null)).subscribe(received => {
      ...
      it('should update a RegionMySuffix', () => {
        service.update(new RegionMySuffix(123)).subscribe(received => {
      ...
      it('should return a RegionMySuffix', () => {
      ...
      it('should return a list of RegionMySuffix', () => {
        ...
        const req = httpMock.expectOne({ method: 'GET' });
        req.flush([new RegionMySuffix(123)]);
      });
