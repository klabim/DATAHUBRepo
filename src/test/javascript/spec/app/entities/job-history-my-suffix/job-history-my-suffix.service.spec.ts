...
describe('Service Tests', () => {
  describe('JobHistoryMySuffix Service', () => {
    ...
    beforeEach(() => {
      ...
      injector = getTestBed();
      service = injector.get(JobHistoryMySuffixService);
    ...
    describe('Service methods', () => {
      it('should call correct URL', () => {
        ...
        const resourceUrl = SERVER_API_URL + 'api/job-histories';
        expect(req.request.url).toEqual(resourceUrl + '/' + 123);
      });

      it('should create a JobHistoryMySuffix', () => {
        service.create(new JobHistoryMySuffix(null)).subscribe(received => {
      ...
      it('should update a JobHistoryMySuffix', () => {
        service.update(new JobHistoryMySuffix(123)).subscribe(received => {
      ...
      it('should return a JobHistoryMySuffix', () => {
      ...
      it('should return a list of JobHistoryMySuffix', () => {
        ...
        const req = httpMock.expectOne({ method: 'GET' });
        req.flush([new JobHistoryMySuffix(123)]);
      });
