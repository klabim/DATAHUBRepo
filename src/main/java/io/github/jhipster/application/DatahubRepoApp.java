...
public class DatahubRepoApp {

    private static final Logger log = LoggerFactory.getLogger(DatahubRepoApp.class);

    private final Environment env;

    public DatahubRepoApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes DATAHUBRepo.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(DatahubRepoApp.class);
